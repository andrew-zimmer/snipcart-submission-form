...
class ImageUploadCard extends React.Component {
  ...
  handleUploadClick = event => {
    ...
    reader.onloadend = function(e) {
      ...
      this.props.setImage([reader.result], event.target.files[0])
    }.bind(this);
  ...
  renderGalleryState() {
    ...
    const photoArray = Array.isArray(this.props.image) ? this.props.image : [this.props.image]
    const listItems = photoArray.map(image => (
        <React.Fragment>
